...
<thead>
    ...
    <td colspan=3>  
    <input type=text name="num" value="5000" size=5>
    </td>
    </tr> 
</table>
...
<?php echo $string;?>
    ...
    <tr>
      ...
      <td colspan=3><input type=text name="email" value="wujingit@qq.com" size=20></td>
    </tr>
    <tr>
      <td align="right" width="100"> <?php echo L('google_nums')?> : </td>
      <td colspan=3><input type=text name="baidunum" value="200" size=5> </td>
    </tr>
